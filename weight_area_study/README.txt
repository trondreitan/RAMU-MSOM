...
* run_weight_expsoure.R - An example run script for the model. You need "model_weight_exposure.R", "3stage_cpu.R" (found in the main folder) and the scripts that "3stage_cpu.R" relies on in order to run this.
