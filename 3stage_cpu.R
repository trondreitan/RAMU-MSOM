...
if(cpus==1)
  ...
  Specs=list(A=Inf, B=NULL, m=100, n=0))
# or 
# Fit1=LaplacesDemon(Model, Data=data, par0,Iterations=2000,Algorithm="UESS", Specs=list(A=Inf, B=NULL, m=100, n=0) )
...
if(cpus==1)
  ...
  Algorithm="CHARM",Covar=Fit2$Covar)
# or
# Fit3=LaplacesDemon(Model, Data=data, par0,Iterations=10000,Thinning=thin,Algorithm="CHARM",Covar=Fit2$Covar)
